...
void main() async  {
  await DB.start();
  testWidgets('PointTest', (WidgetTester tester) async {
    provideMockedNetworkImages (() async{
      Widget pw = PointWidget();
      await tester.pumpWidget(createWidgetForTesting(child: pw));
      PointWidgetState pwState = tester.state(find.byWidget(pw));
      BuildContext context;
      await tester.pumpWidget(createWidgetForTesting(child:pwState.build(context)));
